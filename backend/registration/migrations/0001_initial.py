    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_group', models.CharField(max_length=10)),
                ('user_role', models.CharField(choices=[('Student', 'Student'), ('Provost_Body', 'Provost Body'), ('Official_Person', 'Official Person'), ('Dining', 'Dining'), ('Canteen', 'Canteen'), ('Shop', 'Shop')], default='Provost_Body', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=15)),
                ('password', models.CharField(max_length=100)),
                ('user_role', models.CharField(choices=[('Student', 'Student'), ('Provost_Body', 'Provost Body'), ('Official_Person', 'Official Person'), ('Dining', 'Dining'), ('Canteen', 'Canteen'), ('Shop', 'Shop')], default='Student', max_length=100)),
