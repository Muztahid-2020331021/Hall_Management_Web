    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lost_and_found_posts', to='user_info.userinformation')),
            ],
            options={
